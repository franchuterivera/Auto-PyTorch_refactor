...
class TestNormalizer(unittest.TestCase):
    def test_l2_norm(self):
        data = np.array([[1, 2, 3], [7, 8, 9], [4, 5, 6], [11, 12, 13], [17, 18, 19], [14, 15, 16]])
    ...
    def test_max_norm(self):
        ...
        assert_allclose(
            transformed,
            np.array([[0.77777778, 0.88888889, 1], [0.89473684, 0.94736842, 1], [0.84615385, 0.92307692, 1]]),
        )
...
class TestStandardScaler(unittest.TestCase):
    def test_standard_scaler(self):
        ...
        assert_allclose(
            ...
            np.array(
                [
                    [0.11995203, 0.11995203, 0.11995203],
