...
class TestEncoders(unittest.TestCase):
    def test_one_hot_encoder_no_unknown(self):
        data = np.array([[1, "male"], [1, "female"], [3, "female"], [2, "male"], [2, "female"]])
    ...
    def test_ordinal_encoder(self):
        ...
        data = np.array([[1, "male"], [1, "female"], [3, "male"], [2, "female"], [2, "male"]])
    ...
    def test_none_encoder(self):
        ...
        data = np.array([[1, "male"], [1, "female"], [3, "unknown"], [2, "female"], [2, "male"]])
