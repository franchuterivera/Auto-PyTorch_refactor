...
class TestSimpleImputer(unittest.TestCase):
    def test_get_config_space(self):
        dataset_properties = dict(categorical_columns=[0, 1], numerical_columns=[1, 2])
    ...
    def test_mean_imputation(self):
        ...
        column_transformer = make_column_transformer(
            (categorical_imputer, X["categorical_columns"]),
        ...
        assert_array_equal(
            transformed.astype(str), np.array([[1.0, 8.0, 9.0], [7.0, 3.5, 9.0], [4.0, 3.5, 3.0]], dtype=str)
        )
    ...
    def test_frequent_imputation(self):
        ...
        imputer_component = SimpleImputer(numerical_strategy="most_frequent", categorical_strategy="most_frequent")
        ...
        assert_array_equal(transformed.astype(str), np.array([[1.0, 8, 9], [7.0, 2, 9], [4.0, 2, 3]], dtype=str))
    ...
    def test_constant_imputation(self):
        ...
        imputer_component = SimpleImputer(numerical_strategy="constant_zero", categorical_strategy="constant_!missing!")
        ...
        transformed = column_transformer.transform(data[test_indices])
        assert_array_equal(
            transformed.astype(str), np.array([["!missing!", 8, 9], [7.0, "0", 9], [4.0, "0", "0"]], dtype=str)
        )
