...
class DummyChoice(autoPyTorchChoice):
    ...
    def get_hyperparameter_search_space(self, dataset_properties=None, default=None, include=None, exclude=None):
        cs = CS.ConfigurationSpace()
        cs.add_hyperparameter(CSH.CategoricalHyperparameter("__choice__", list(self.get_components().keys()),))
        return cs
...
class PipelineTest(unittest.TestCase):
    ...
    def test_pipeline_base_config_space(self):
        ...
        cs = self.pipeline._get_base_search_space(
            cs=CS.ConfigurationSpace(), include={}, exclude={}, dataset_properties={}, pipeline=self.pipeline.steps
        )
        ...
        self.assertEqual(10, cs.get_hyperparameter("DummyComponent1:a").lower)
        ...
        self.assertEqual(
            ("DummyComponent2", "DummyComponent3"), cs.get_hyperparameter("DummyChoice:__choice__").choices
        )
    ...
    def test_pipeline_set_config(self):
        ...
        self.assertEqual(config_dict["DummyComponent1:a"], self.pipeline.named_steps["DummyComponent1"].a)
        self.assertEqual(config_dict["DummyComponent1:b"], self.pipeline.named_steps["DummyComponent1"].b)
        ...
        self.assertEqual("orange", self.pipeline.named_steps["DummyChoice"].choice.b)
