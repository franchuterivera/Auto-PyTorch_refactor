...
class PipelineTest(unittest.TestCase):
    ...
    def test_network_optimizer_lr_handshake(self):
        ...
        X = pipeline.named_steps["network"].fit({"num_features": 10, "num_classes": 2}, None).transform({})
        ...
        with self.assertRaisesRegex(ValueError, "the fit dictionary Must contain a valid optimizer"):
